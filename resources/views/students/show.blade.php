...
<!-- Page Heading -->
<a href="{{route('studentsindex')}}" class="btn btn-secondary">Back</a>
<h1 class="h3 mb-2 text-gray-800" style="text-align:center">Student Page</h1><br>
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{$student->last_name}}</p>
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              <div class="col-sm-3">
                <p class="mb-0">Skill/Occupation</p>
              </div>
              <div class="col-sm-9">
