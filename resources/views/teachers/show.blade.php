...
<!-- Page Heading -->
<a href="{{route('teachersindex')}}" class="btn btn-secondary">Back</a>
<h1 class="h3 mb-2 text-gray-800" style="text-align:center">Teacher Page</h1><br>
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{$teacher->last_name}}</p>
              </div>
            </div>
            <hr>
            <div class="row">
